...
class DetailViewController: BaseViewController {
    ...
    private func createTop() {
        ...
        descLabel.font = UIFont.systemFont(ofSize: 13, weight: .light)
        ...
        courseCountLabel.font = UIFont.systemFont(ofSize: 13)
        ...
        studentAttachment.bounds = CGRect(x: -2, y: -3, width: studentAttachment.image? .size.width ?? 00, height: studentAttachment.image?.size.height ?? 0)
        let studentAttachString = NSAttributedString(attachment: studentAttachment)
        let studentcountString = NSMutableAttributedString(string: "")
        studentcountString.append(studentAttachString)
        ...
        studentCountLabel.font = UIFont.systemFont(ofSize: 13)
    ...
    private func createBottom() {
        ...
        button.snp.makeConstraints { (make) in
            ...
            make.height.equalTo(SystemUtil.isFullScreen() ? 80 : 50)
        }
    }
